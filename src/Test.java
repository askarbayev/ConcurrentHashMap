...
public class Test {
    public static void main(String [] args) throws InterruptedException {
        ...
        for (int numThreads = 1; numThreads < THREADS_MAX; numThreads++) {
            final CuncurrentHashMap myConcurrentHashMap = new CuncurrentHashMap();
            ...
            System.out.println(String.format("%s with %d threads: %dms (throughput: %.1f ops/s)", CuncurrentHashMap.class.getSimpleName(), numThreads, totalMillis, throughput));
